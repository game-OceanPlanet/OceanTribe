module qmr {
	...
	export class SettingUtil {
		...
		public constructor() {
			this.sVariantType = 0;
			let flag: string = egret.localStorage.getItem(qmr.PlatformConfig.channelId + "zgmrsetting"+GlobalConfig.userId);
		...
		public setForbidState(bit: number, value: number): void {
			...
			egret.localStorage.setItem(qmr.PlatformConfig.channelId + "zgmrsetting"+GlobalConfig.userId, this.sVariantType + "");
		}
	}
}